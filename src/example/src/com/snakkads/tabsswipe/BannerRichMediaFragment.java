...
public class BannerRichMediaFragment extends Fragment {
    ...
    public BannerRichMediaFragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.e(TAG,  getResources().getString(R.string.banner_rich_zone_id));
...
//        bannerAdView.setAdUpdateInterval(0); // no auto rotation
        ...
        String zoneId = getResources().getString(R.string.banner_rich_zone_id);

        Map<String, String> params = new HashMap<String, String>(1);
        String cid = getResources().getString(R.string.banner_rich_zone_cid);
        params.put("cid", cid);
